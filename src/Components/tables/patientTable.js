...
class PatientTable extends Component {
        ...
        if(tokenDesi== null || tokenVal == null)
    {
        ...
        {this.state.data.length>0 ? <TableDom headers={Object.keys(this.state.data[0])} body= {this.state.data} link="http://localhost:9080/api/deletePatient" getLink = "http://localhost:9080/api/showPatient" updateURL = "/updatePatient" addURL = "/addPatient" props={this.props} pkId = {Object.keys(this.state.data[0])[0]}/> : null}
        </div></div></> );
    }
}
